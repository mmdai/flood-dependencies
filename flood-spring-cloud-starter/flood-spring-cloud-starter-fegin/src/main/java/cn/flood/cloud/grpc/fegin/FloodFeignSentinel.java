      ...
      super.invocationHandlerFactory(new InvocationHandlerFactory() {
        ...
        public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
          ...
          if (void.class != fallback) {
            ...
            return new FloodSentinelInvocationHandler(target, dispatch,
      ...
      super.requestInterceptor(new RequestInterceptor() {
        ...
        public void apply(RequestTemplate requestTemplate) {
          ...
          if (attributes != null) {
            ...
            if (Func.isNotEmpty(version) && !requestTemplate.headers()
                .containsKey(HeaderConstant.HEADER_VERSION)) {
              requestTemplate.header(HeaderConstant.HEADER_VERSION, version);
            }
            //传递租户ID
            requestTemplate.header(HeaderConstant.TENANT_ID,
                Func.toStr(request.getHeader(HeaderConstant.TENANT_ID),
                    HeaderConstant.DEFAULT_TENANT_ID));
