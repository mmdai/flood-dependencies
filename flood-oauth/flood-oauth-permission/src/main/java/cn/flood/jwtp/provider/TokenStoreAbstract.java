...
public abstract class TokenStoreAbstract implements TokenStore {
  ...
  @Override
  public UserToken createNewToken(PlatformEnum platform, String tenantId, String userId,
      String userInfo, boolean needRt) {
  ...
  @Override
  public UserToken createNewToken(PlatformEnum platform, String tenantId, String userId,
      String userInfo, long expire, boolean needRt) {
  ...
  @Override
  public UserToken createNewToken(PlatformEnum platform, String tenantId, String userId,
      String userInfo, long expire, long rtExpire) {
  ...
  @Override
  public UserToken createNewToken(PlatformEnum platform, String tenantId, String userId,
      String userInfo, String[] permissions, String[] roles, boolean needRt) {
    return createNewToken(platform, tenantId, userId, userInfo, permissions, roles,
        TokenUtil.DEFAULT_EXPIRE, needRt);
  }
  ...
  @Override
  public UserToken createNewToken(PlatformEnum platform, String tenantId, String userId,
      String userInfo, String[] permissions, String[] roles, long expire, boolean needRt) {
    return createNewToken(platform, tenantId, userId, userInfo, permissions, roles, expire,
        TokenUtil.DEFAULT_EXPIRE_REFRESH_TOKEN, needRt);
  }
  ...
  @Override
  public UserToken createNewToken(PlatformEnum platform, String tenantId, String userId,
      String userInfo, String[] permissions, String[] roles, long expire, long rtExpire) {
    return createNewToken(platform, tenantId, userId, userInfo, permissions, roles, expire,
        rtExpire, true);
  }
  ...
  public UserToken createNewToken(PlatformEnum platform, String tenantId, String userId,
    ...
    UserToken userToken = TokenUtil
        .buildToken(platform, tenantId, userId, expire, rtExpire, TokenUtil.parseHexKey(tokenKey),
            needRt);
   ...
   */
  @Override
  public UserToken refreshToken(PlatformEnum platform, String tenantId, String refresh_token)
      throws CoreException {
  ...
  @Override
  public UserToken refreshToken(PlatformEnum platform, String tenantId, String refresh_token,
      String userInfo) throws CoreException {
  ...
  @Override
  public UserToken refreshToken(PlatformEnum platform, String tenantId, String refresh_token,
      String userInfo, long expire) throws CoreException {
  ...
  @Override
  public UserToken refreshToken(PlatformEnum platform, String tenantId, String refresh_token,
      String userInfo, String[] permissions, String[] roles, long expire) throws CoreException {
    String tokenKey = getTokenKey();
    logger.debug("TOKEN_KEY: " + tokenKey);
    tenantId = Func.toStr(tenantId, HeaderConstant.DEFAULT_TENANT_ID);
    String userId;
    ...
    if (userId != null) {
      ...
      // 生成新的token
      UserToken userToken = TokenUtil
          .buildToken(platform, tenantId, userId, expire, null, TokenUtil.parseHexKey(tokenKey),
              false);
      userToken.setRoles(roles);
      if (Func.isNotEmpty(userInfo)) {
        userToken.setUserInfo(userInfo);
