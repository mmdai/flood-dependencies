...
public class SwaggerAutoConfiguration {
    ...
    public static GroupedOpenApi buildGroupedOpenApi(String group, String path) {
        return GroupedOpenApi.builder()
                ...
                .addOperationCustomizer((operation, handlerMethod) -> operation
                        ...
                        .addParametersItem(buildPlatformHeaderParameter())
                        .addParametersItem(buildCaptchaKeyHeaderParameter())
                        .addParametersItem(buildCaptchaCodeHeaderParameter())
    ...
    private static Parameter buildVersionHeaderParameter() {
        return new Parameter()
                .name("version") // header 名
                .description("版本号") // 描述
                .in(String.valueOf(SecurityScheme.In.HEADER)) // 请求 header
                .schema(new StringSchema()._default("v1.0.0").name("version").description("版本号")); // 默认：使用版本编号为 v1.0.0
    }

    /**
     * 构建 client_id 平台请求头参数
     *
     * @return 版本号
     */
