 ...
 * @author Chill
 */
public class FloodHttpServletRequestWrapper extends HttpServletRequestWrapper {
	...
	public FloodHttpServletRequestWrapper(HttpServletRequest request) {
		super(request);
		orgRequest = request;
	}
	...
	public static HttpServletRequest getOrgRequest(HttpServletRequest request) {
		if (request instanceof FloodHttpServletRequestWrapper) {
			return ((FloodHttpServletRequestWrapper) request).getOrgRequest();
		}
		return request;
	}
