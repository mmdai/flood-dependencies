package cn.flood.db.mybatis.plus.languagedriver;
...
public class ConditionsParameterHandler extends DefaultParameterHandler {
  ...
  public ConditionsParameterHandler(MappedStatement mappedStatement, Object parameterObject,
      BoundSql boundSql) {
    ...
    if (parameterMappings != null) {
      for (int i = 0; i < parameterMappings.size(); i++) {
        ...
        if (parameterMapping.getMode() != ParameterMode.OUT) {
          ...
          if (boundSql
              .hasAdditionalParameter(propertyName)) { // issue #448 ask first for additional params
