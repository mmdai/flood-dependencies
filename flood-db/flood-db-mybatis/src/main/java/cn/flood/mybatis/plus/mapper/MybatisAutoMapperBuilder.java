...
import cn.flood.mybatis.plus.MybatisConfiguration;
import cn.flood.mybatis.plus.constant.Template;
import cn.flood.mybatis.plus.languagedriver.ConditionsLanguageDriver;
import cn.flood.mybatis.plus.support.BaseMapper;
...
public class MybatisAutoMapperBuilder   {
    ...
    /** 批量添加数据 */
    private void batchAdd(MapperBuilderAssistant builderAssistant, Class<?> mapperClass, Class<?> modelClass, Table table) {
    ...
    /** 批量增量更新数据 */
    private void batchUpdate(MapperBuilderAssistant builderAssistant, Class<?> mapperClass, Class<?> modelClass, Table table) {
