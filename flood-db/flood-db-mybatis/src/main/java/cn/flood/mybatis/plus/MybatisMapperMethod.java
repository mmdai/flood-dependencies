...
public class MybatisMapperMethod extends MapperMethod {
    ...
    public static class MethodSignature {
        ...
        public MethodSignature(Configuration configuration, Class<?> mapperInterface, Method method) {
            ...
            Integer rowBoundsParamIndex = getUniqueParamIndex(method, RowBounds.class);
            // this.rowBoundsIndex = getUniqueParamIndex(method, RowBounds.class);
            if(null != rowBoundsParamIndex){
                this.rowBoundsIndex = rowBoundsParamIndex;
            }else {
        ...
        public RowBounds extractRowBounds(Object[] args) {
            if(hasRowBounds()){
                Object arg = args[rowBoundsIndex];
                if(arg instanceof Page){
                    Page page = (Page) arg;
                    return new MybatisRowBounds(page);
                }
                return (RowBounds) args[rowBoundsIndex];
            }
            return null;
        ...
        private SortedMap<Integer, String> getParams(Method method, boolean hasNamedParameters) {
            ...
            final Class<?>[] argTypes = method.getParameterTypes();
            for (int i = 0; i < argTypes.length; i++) {
                if (!Page.class.isAssignableFrom(argTypes[i]) && !RowBounds.class.isAssignableFrom(argTypes[i]) && !ResultHandler.class.isAssignableFrom(argTypes[i])) {
