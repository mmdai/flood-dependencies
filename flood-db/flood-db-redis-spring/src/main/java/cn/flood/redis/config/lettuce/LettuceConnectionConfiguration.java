...
import cn.flood.redis.builder.RedisConnectionFactoryBuilder;
import cn.flood.redis.config.properties.DynamicRedisProperties;
...
public class LettuceConnectionConfiguration extends RedisConnectionConfiguration {
    ...
    private LettuceConnectionFactory dynamicBuild(RedisProperties properties) {
        RedisStandaloneConfiguration redisStandaloneConfiguration = RedisConnectionFactoryBuilder.getRedisStandaloneConfiguration(properties);
        RedisClusterConfiguration redisClusterConfiguration = RedisConnectionFactoryBuilder.getRedisClusterConfiguration(properties);
        RedisSentinelConfiguration redisSentinelConfiguration = RedisConnectionFactoryBuilder.getRedisSentinelConfiguration(properties);
