package cn.flood.db.redis.config;
...
public abstract class RedisConnectionConfiguration {
  ...
  protected final GenericObjectPoolConfig getPoolConfig(
  ...
  protected final RedisStandaloneConfiguration getStandaloneConfig() {
    ...
    if (StringUtils.hasText(this.properties.getUrl())) {
      RedisConnectionConfiguration.ConnectionInfo connectionInfo = parseUrl(
          this.properties.getUrl());
      config.setHostName(connectionInfo.getHostName());
      config.setPort(connectionInfo.getPort());
      config.setPassword(RedisPassword.of(connectionInfo.getPassword()));
    } else if (StringUtils.hasText(this.properties.getHost()) && !"localhost"
        .equals(this.properties.getHost())) {
