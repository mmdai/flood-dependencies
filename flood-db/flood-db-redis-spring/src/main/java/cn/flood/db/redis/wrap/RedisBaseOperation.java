...
public class RedisBaseOperation {
  ...
  @SuppressWarnings("unchecked")
  public static <T> T getHash(RedisTemplate<String, Object> redisTemplate, String key,
      String field) {
    HashOperations<String, String, Object> hash = redisTemplate.opsForHash();
    return (T) hash.get(key, field);
  }

  public static Map<String, Object> getAllHash(RedisTemplate<String, Object> redisTemplate,
      String key) {
    HashOperations<String, String, Object> hash = redisTemplate.opsForHash();
  ...
  @SuppressWarnings("unchecked")
  public static <T> boolean setHash(RedisTemplate<String, Object> redisTemplate, String key,
  ...
  @SuppressWarnings("unchecked")
  public static <T> boolean setHash(RedisTemplate<String, Object> redisTemplate, String key,
      String field, T value, Long expireTime, TimeUnit timeUnit) {
    try {
      HashOperations<String, String, Object> hash = redisTemplate.opsForHash();
      hash.put(key, field, value);
  ...
  public static boolean setAllHash(RedisTemplate<String, Object> redisTemplate, String key,
  ...
  public static boolean setAllHash(RedisTemplate<String, Object> redisTemplate, String key,
      Map<String, Object> value, Long expireTime, TimeUnit timeUnit) {
    try {
      if (value.isEmpty()) {
        return false;
      }
  ...
  public static Long hIncrBy(RedisTemplate<String, Object> redisTemplate, String hKey, String field,
      Long value) {
    HashOperations<String, String, Object> hash = redisTemplate.opsForHash();
  ...
  public static Double hIncrBy(RedisTemplate<String, Object> redisTemplate, String hKey,
  ...
  protected static boolean expire(RedisTemplate<String, Object> redisTemplate, String key,
  ...
  @SuppressWarnings("unchecked")
  public static <T> boolean setIfPresent(RedisTemplate<String, Object> redisTemplate, String key,
      T value, Long expireTime, TimeUnit timeUnit) {
    try {
      ValueOperations<String, Object> operations = redisTemplate.opsForValue();
  ...
  public static long setLPush(RedisTemplate<String, Object> redisTemplate, String lKey,
      String lValue) {
  ...
  public static long setRPush(RedisTemplate<String, Object> redisTemplate, String lKey,
      String lValue) {
