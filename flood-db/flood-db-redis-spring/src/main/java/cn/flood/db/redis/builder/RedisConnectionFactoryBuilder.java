...
/**
 * 根据配置属性构建RedisConnectionFactoryBuilder 根据配置文件中的配置 RedisConnectionFactory
 */
public class RedisConnectionFactoryBuilder {
   ...
   * @return
   */
  public static RedisStandaloneConfiguration getRedisStandaloneConfiguration(
   ...
   * @return
   */
  public static RedisSentinelConfiguration getRedisSentinelConfiguration(
      RedisProperties properties) {
