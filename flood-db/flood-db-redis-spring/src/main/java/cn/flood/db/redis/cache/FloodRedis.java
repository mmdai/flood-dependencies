 ...
 * @author mmdai
 * @version 1.0.0
 * @ClassName FloodRedis
 * @Description
 * @createTime 2024年07月16日 13:32
 */
@Getter
@SuppressWarnings("unchecked")
public class FloodRedis {
    ...
    public FloodRedis(RedisTemplate<String, Object> redisTemplate, StringRedisTemplate stringRedisTemplate) {
    ...
    public Long getDecr(String key) {
        return toLong(stringRedisTemplate.opsForValue().get(key), 0L);
    }
