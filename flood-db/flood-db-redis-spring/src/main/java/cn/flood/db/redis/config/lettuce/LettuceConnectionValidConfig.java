...
/**
 * lettuce提供了校验连接的方法，lettuce提供了校验连接的方法 只是默认没开启 开启的话是每次获取连接都会校验，开启获取连接的校验。
 */
@AutoConfiguration
public class LettuceConnectionValidConfig implements InitializingBean {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    Map<String, RedisTemplate<String, Object>> redisConnectionFactoryMap = redisTemplaterFactoryBuild
        .getRedisTemplateMap();
