...
public interface RedisService {
   ...
   * @throws
   */
  <T> boolean setHash(final String key, final String field, T value, Long expireTime,
      TimeUnit timeUnit);
   ...
   * @throws
   */
  boolean setAllHash(final String key, Map<String, Object> value, Long expireTime,
      TimeUnit timeUnit);
   ...
   * @return 返回对象集合
   */
  Set ascRangeByLexZSet(String key, Long startSortIndex, boolean isContainsStart, Long endSortIndex,
   ...
   * @return 返回对象字典
   */
  Map<Double, Object> rangeByScoreWithScoresZSet(String key, Double min, Double max, Long count,
      Long offset);
   ...
   * @return 返回包含的对象
   */
  GeoResults<RedisGeoCommands.GeoLocation<Object>> radiusByMemberWithResult(String key,
