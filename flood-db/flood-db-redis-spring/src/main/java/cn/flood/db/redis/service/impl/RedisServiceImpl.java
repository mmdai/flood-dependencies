...
public class RedisServiceImpl implements RedisService {
  ...
  @SuppressWarnings("unchecked")
  @Override
  public <T> boolean setHash(String key, String field, T value, Long expireTime,
      TimeUnit timeUnit) {
    try {
      HashOperations<String, String, Object> hash = this.redisTemplate.opsForHash();
      hash.put(key, field, value);
   ...
   */
  @Override
  public boolean setAllHash(String key, Map<String, Object> value, Long expireTime,
      TimeUnit timeUnit) {
    try {
      if (value.isEmpty()) {
        return false;
  ...
  public Long differenceAndStoreSet(String key, String storeKey, String... otherKys) {
    return this.redisTemplate.opsForSet()
        .differenceAndStore(key, Arrays.asList(otherKys), storeKey);
  }
  ...
  public Cursor scanSet(String key, Long count, String pattern) {
    return this.redisTemplate.opsForSet()
        .scan(key, ScanOptions.scanOptions().count(count).match(pattern).build());
  }
  /****************************** SET END ***********************************/
   ...
   */
  @Override
  public Set ascRangeByLexZSet(String key, Long startSortIndex, boolean isContainsStart,
      Long endSortIndex, boolean isContainsEnd) {
   ...
   * @return 返回范围对象
   */
  private RedisZSetCommands.Range getRange(Long startSortIndex, boolean isContainsStart,
      Long endSortIndex, boolean isContainsEnd) {
  ...
  @Override
  public Set ascRangeByLexZSet(String key, Long startSortIndex, boolean isContainsStart,
      Long endSortIndex, boolean isContainsEnd, Integer count, Integer offset) {
    return this.redisTemplate.opsForZSet().rangeByLex(
        key,
        this.getRange(startSortIndex, isContainsStart, endSortIndex, isContainsEnd)
    );
  ...
  public Map<Double, Object> rangeByScoreZSet(String key, Long startSortIndex, Long endSortIndex) {
    return ConvertUtil
        .toMap(this.redisTemplate.opsForZSet().rangeWithScores(key, startSortIndex, endSortIndex));
  }
  ...
  public Map<Double, Object> rangeByScoreWithScoresZSet(String key, Double min, Double max,
    ...
    return ConvertUtil.toMap(
        this.redisTemplate.opsForZSet().rangeByScoreWithScores(key, min, max, offset, count));
  }
  ...
  public Long intersectAndStoreZSet(String key, String storeKey, String... otherKys) {
    return this.redisTemplate.opsForZSet()
        .intersectAndStore(key, Arrays.asList(otherKys), storeKey);
  }
  ...
  public Map<Double, Object> reverseRangeByScoreZSet(String key, Long startIndex, Long endIndex) {
    return ConvertUtil
        .toMap(this.redisTemplate.opsForZSet().reverseRangeWithScores(key, startIndex, endIndex));
  }
  ...
  public Map<Double, Object> reverseRangeByScoreWithScoresZSet(String key, Double min, Double max) {
    return ConvertUtil
        .toMap(this.redisTemplate.opsForZSet().reverseRangeByScoreWithScores(key, min, max));
  }
  ...
  public Map<Double, Object> reverseRangeByScoreWithScoresZSet(String key, Double min, Double max,
      Long count, Long offset) {
    return ConvertUtil.toMap(this.redisTemplate.opsForZSet()
   ...
   */
  @Override
  public Cursor<ZSetOperations.TypedTuple<Object>> scanZSet(String key, Long count,
      String pattern) {
    return this.redisTemplate.opsForZSet()
        .scan(key, ScanOptions.scanOptions().count(count).match(pattern).build());
  }
  ...
  public List<Object> radiusByMember(String key, Object value, Distance distance) {
    GeoResults<RedisGeoCommands.GeoLocation<Object>> results = this.redisTemplate.opsForGeo()
        .radius(key, value, distance);
  ...
  public List<Object> radiusByMember(String key, Object value, Distance distance,
    ...
    GeoResults<RedisGeoCommands.GeoLocation<Object>> results = this.redisTemplate.opsForGeo()
        .radius(key, value, distance, args);
    return ConvertUtil.toList(results);
  }
   ...
   */
  @Override
  public GeoResults<RedisGeoCommands.GeoLocation<Object>> radiusByMemberWithResult(String key,
  ...
  @Override
  public GeoResults<RedisGeoCommands.GeoLocation<Object>> radiusByMemberWithResult(String key,
      Object value, Distance distance, RedisGeoCommands.GeoRadiusCommandArgs args) {
   ...
   */
  @Override
  public GeoResults<RedisGeoCommands.GeoLocation<Object>> radiusWithResult(String key,
      Circle within) {
