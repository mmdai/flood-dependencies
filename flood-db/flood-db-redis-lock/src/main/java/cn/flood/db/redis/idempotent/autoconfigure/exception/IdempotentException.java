package cn.flood.db.redis.idempotent.autoconfigure.exception;

import cn.flood.base.core.exception.CoreException;
import org.springframework.context.support.DefaultMessageSourceResolvable;

/**
 * Idempotent Exception If there is a custom global exception, you need to inherit the custom global
 * exception.
 *
 * @author daimm
 */
public class IdempotentException extends CoreException {
  ...
  public IdempotentException(String code, Throwable error) {
    super(code, error);
    messageSourceResolvable = new DefaultMessageSourceResolvable(new String[]{code}, null,
        error.getMessage());
  }
  ...
  public IdempotentException(String code, String msg, Throwable error) {
    super(code, error);
    messageSourceResolvable = new DefaultMessageSourceResolvable(new String[]{code},
        new Object[]{error.getClass().getName()}, msg);
  }
