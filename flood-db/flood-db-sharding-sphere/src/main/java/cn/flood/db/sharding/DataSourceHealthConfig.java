...
/**
 * 解决 DataSource health check failed org.springframework.dao.InvalidDataAccessApiUsageException:
 * ConnectionCallback; isValid 数据库health健康检查异常问题
 *
 * @author mmdai
 * @version 1.0
...
public class DataSourceHealthConfig {
   ...
   * 不可用的数据源池元数据.
   */
  private class DruidDataSourcePoolMetadata extends
      AbstractDataSourcePoolMetadata<DruidDataSource> {
