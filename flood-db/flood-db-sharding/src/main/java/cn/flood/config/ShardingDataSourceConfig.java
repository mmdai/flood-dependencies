...
public class ShardingDataSourceConfig {
    ...
    public DataSource masterSlaveDataSource() throws SQLException {
        ...
        DataSource dataSource = MasterSlaveDataSourceFactory.createDataSource(dataSourceMap, 
        		new MasterSlaveRuleConfiguration(shardingMasterSlaveProperties.getMasterSlaveRule().getName(),
        				...
        				Strings.isNullOrEmpty(
        					shardingMasterSlaveProperties.getMasterSlaveRule().getLoadBalanceAlgorithmType()) ? null : new LoadBalanceStrategyConfiguration(shardingMasterSlaveProperties.getMasterSlaveRule().getLoadBalanceAlgorithmType())
        						), new Properties());
