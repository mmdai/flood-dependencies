  ...
  public void afterPropertiesSet() {
    ...
    for (DataSourceRegisterInfo dsource : sourceConfig) {
      ...
      if (dsource.isThreadPool()) {
        ...
        ds.setInitialSize(Func.isNotEmpty(dsource.getInitialSize()) ? dsource.getInitialSize()
            : druidDbProperties.getInitialSize());
        ds.setMinIdle(Func.isNotEmpty(dsource.getMinIdle()) ? dsource.getMinIdle()
            : druidDbProperties.getMinIdle());
        ds.setMaxActive(Func.isNotEmpty(dsource.getMaxActive()) ? dsource.getMaxActive()
        ...
        ds.setMinEvictableIdleTimeMillis(
            Func.isNotEmpty(dsource.getMinEvictableIdleTimeMillis()) ? dsource
        ...
        ds.setTestOnBorrow(Func.isNotEmpty(dsource.getTestOnBorrow()) ? dsource.getTestOnBorrow()
            : druidDbProperties.isTestOnBorrow());
        ds.setTestOnReturn(Func.isNotEmpty(dsource.getTestOnReturn()) ? dsource.getTestOnReturn()
            : druidDbProperties.isTestOnReturn());
        ds.setRemoveAbandoned(
            Func.isNotEmpty(dsource.getRemoveAbandoned()) ? dsource.getRemoveAbandoned()
                : druidDbProperties.isRemoveAbandoned());
        ds.setRemoveAbandonedTimeout(Func.isNotEmpty(dsource.getRemoveAbandonedTimeout()) ? dsource
            .getRemoveAbandonedTimeout() : druidDbProperties.getRemoveAbandonedTimeout());
        ds.setPoolPreparedStatements(Func.isNotEmpty(dsource.getPoolPreparedStatements()) ? dsource
            .getPoolPreparedStatements() : druidDbProperties.isPoolPreparedStatements());
        ds.setMaxPoolPreparedStatementPerConnectionSize(
            Func.isNotEmpty(dsource.getMaxPoolPreparedStatementPerConnectionSize()) ? dsource
        ...
        try {
          if (Func.isNotEmpty(dsource.getDriverClassName())
            ...
            ds.setFilters(Func.isNotEmpty(dsource.getFilters()) ? dsource.getFilters()
                : druidDbProperties.getFilters());
          }
        ...
        ds.setUseGlobalDataSourceStat(
            Func.isNotEmpty(dsource.getUseGlobalDataSourceStat()) ? dsource
                .getUseGlobalDataSourceStat() : druidDbProperties.isUseGlobalDataSourceStat());
