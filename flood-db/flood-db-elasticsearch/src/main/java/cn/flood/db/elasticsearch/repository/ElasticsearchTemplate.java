...
/**
 * program: esdemo description: Elasticsearch基础功能组件 author: X-Pacific zhang create: 2019-01-18
 * 16:01
 **/
public interface ElasticsearchTemplate<T, M> {
   ...
   * @throws Exception
   */
  BulkResponse batchUpdate(QueryBuilder queryBuilder, T t, Class clazz, int limitcount,
   ...
   * @throws Exception
   */
  BulkByScrollResponse deleteByCondition(QueryBuilder queryBuilder, Class<T> clazz)
      throws Exception;
   ...
   * @throws Exception
   */
  List<T> searchMore(QueryBuilder queryBuilder, int limitSize, Class<T> clazz, String... indexs)
      throws Exception;
   ...
   * @throws Exception
   */
  List<T> searchUri(String uri, Class<T> clazz) throws Exception;
   ...
   * @throws Exception
   */
  PageList<T> search(QueryBuilder queryBuilder, PageSortHighLight pageSortHighLight, Class<T> clazz)
      throws Exception;
   ...
   * @throws Exception
   */
  PageList<T> search(QueryBuilder queryBuilder, Attach attach, Class<T> clazz, String... indexs)
      throws Exception;
   ...
   */
  @Deprecated
  List<T> scroll(QueryBuilder queryBuilder, Class<T> clazz, Long time, String... indexs)
      throws Exception;
   ...
   * @throws Exception
   */
  ScrollResponse<T> createScroll(QueryBuilder queryBuilder, Class<T> clazz, Long time, Integer size)
      throws Exception;
   ...
   * @throws Exception
   */
  ScrollResponse<T> queryScroll(Class<T> clazz, Long time, String scrollId) throws Exception;
   ...
   * @throws Exception
   */
  ClearScrollResponse clearScroll(String... scrollId) throws Exception;
   ...
   * @return
   */
  List<T> searchTemplate(Map<String, Object> template_params, String templateName, Class<T> clazz)
      throws Exception;
   ...
   * @return
   */
  List<T> searchTemplateBySource(Map<String, Object> template_params, String templateSource,
   ...
   * @return
   */
  Response saveTemplate(String templateName, String templateSource) throws Exception;
   ...
   * @throws Exception
   */
  List<String> completionSuggest(String fieldName, String fieldValue, Class<T> clazz)
      throws Exception;
   ...
   * @throws Exception
   */
  List<String> phraseSuggest(String fieldName, String fieldValue,
      ElasticsearchTemplateImpl.PhraseSuggestParam param, Class<T> clazz) throws Exception;
   ...
   */
  List<String> phraseSuggest(String fieldName, String fieldValue,
      ElasticsearchTemplateImpl.PhraseSuggestParam param, Class<T> clazz, String... indexs)
      throws Exception;
   ...
   * @return
   */
  Map aggs(String metricName, AggsType aggsType, QueryBuilder queryBuilder, Class<T> clazz,
  ...
  /**
   * 以aggstypes的方式metric度量，请结合 https://gitee.com/zxporz/ESClientRHL/wikis/Elasticsearch-ESClientRHL
   * 使用
   *
   * @param metricName   度量字段名称
   * @param aggsType     度量类型
   ...
   * @throws Exception
   */
  double aggs(String metricName, AggsType aggsType, QueryBuilder queryBuilder, Class<T> clazz)
      throws Exception;
   ...
   * @throws Exception
   */
  List<Down> aggswith2level(String metricName, AggsType aggsType, QueryBuilder queryBuilder,
   ...
   * @throws Exception
   */
  Stats statsAggs(String metricName, QueryBuilder queryBuilder, Class<T> clazz, String... indexs)
      throws Exception;

  /**
   * 以bucket分组，统计聚合metric度量，请结合 https://gitee.com/zxporz/ESClientRHL/wikis/Elasticsearch-ESClientRHL
   * 使用
   *
   * @param metricName   度量字段名称
   * @param queryBuilder 查询条件
   ...
   * @throws Exception
   */
  Map<String, Stats> statsAggs(String metricName, QueryBuilder queryBuilder, Class<T> clazz,
      String bucketName) throws Exception;
   ...
   * @throws Exception
   */
  Aggregations aggs(AggregationBuilder aggregationBuilder, QueryBuilder queryBuilder,
      Class<T> clazz) throws Exception;
   ...
   * @throws Exception
   */
  long cardinality(String metricName, QueryBuilder queryBuilder, long precisionThreshold,
      Class<T> clazz) throws Exception;
   ...
   * @throws Exception
   */
  long cardinality(String metricName, QueryBuilder queryBuilder, Class<T> clazz, String... indexs)
      throws Exception;
  ...
  /**
   * 百分比聚合 默认聚合见Constant.DEFAULT_PERCSEGMENT，请结合 https://gitee.com/zxporz/ESClientRHL/wikis/Elasticsearch-ESClientRHL
   * 使用
   *
   * @param metricName   度量字段名称
   * @param queryBuilder 查询条件
   ...
   * @throws Exception
   */
  Map percentilesAggs(String metricName, QueryBuilder queryBuilder, Class<T> clazz)
      throws Exception;
  ...
  /**
   * 以百分等级聚合 (统计在多少数值之内占比多少)，请结合 https://gitee.com/zxporz/ESClientRHL/wikis/Elasticsearch-ESClientRHL
   * 使用
   *
   * @param metricName    度量字段名称
   * @param queryBuilder  查询条件
   ...
   * @throws Exception
   */
  Map percentileRanksAggs(String metricName, QueryBuilder queryBuilder, Class<T> clazz,
  ...
  /**
   * 过滤器聚合，请结合 https://gitee.com/zxporz/ESClientRHL/wikis/Elasticsearch-ESClientRHL 使用 new
   * FiltersAggregator.KeyedFilter("men", QueryBuilders.termQuery("gender", "male"))
   *
   * @param metricName   度量字段名称
   * @param aggsType     度量类型
   * @param clazz        索引pojo类类型
   ...
   * @throws Exception
   */
  Map filterAggs(String metricName, AggsType aggsType, QueryBuilder queryBuilder, Class<T> clazz,
   ...
   */
  Map filterAggs(String metricName, AggsType aggsType, QueryBuilder queryBuilder, Class<T> clazz,
      FiltersAggregator.KeyedFilter[] filters, String... indexs) throws Exception;
   ...
   * @throws Exception
   */
  Map histogramAggs(String metricName, AggsType aggsType, QueryBuilder queryBuilder, Class<T> clazz,
      String bucketName, double interval) throws Exception;
   ...
   */
  Map histogramAggs(String metricName, AggsType aggsType, QueryBuilder queryBuilder, Class<T> clazz,
      String bucketName, double interval, String... indexs) throws Exception;
   ...
   * @throws Exception
   */
  Map dateHistogramAggs(String metricName, AggsType aggsType, QueryBuilder queryBuilder,
