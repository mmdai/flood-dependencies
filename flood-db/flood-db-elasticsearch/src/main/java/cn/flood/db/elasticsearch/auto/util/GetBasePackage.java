...
/**
 * program: esclientrhl description: 获取basepackage列表 author: X-Pacific zhang create: 2019-09-02
 * 22:12
 **/
public class GetBasePackage {
  ...
  public Stream<String> getBasePackage(AnnotationMetadata annotationMetadata) {
    ...
    //配了注解
    return Stream.of(Arrays.asList(value), Arrays.asList(basePackages), Arrays.asList(entityPaths))
