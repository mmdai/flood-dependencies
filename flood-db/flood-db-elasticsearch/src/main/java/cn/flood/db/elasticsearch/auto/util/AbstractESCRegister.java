...
public abstract class AbstractESCRegister {
  ...
  public void registerBeanDefinitions(BeanFactory factory, Environment environment,
      ResourceLoader resourceLoader, AnnotationMetadata annotationMetadata,
      BeanDefinitionRegistry registry) {
    getCandidates(annotationMetadata, registry, environment, resourceLoader)
        .forEach(beanDefinition -> {
          BeanDefinitionBuilder beanDefinitionBuilder = BeanDefinitionBuilder
              .genericBeanDefinition(RepositoryFactorySupport.class);
   ...
   * @return
   */
  public Stream<BeanDefinition> getCandidates(AnnotationMetadata annotationMetadata,
    ...
    return getBasePackage(annotationMetadata)
   ...
   */
  private static class ESCRepositoryComponentProvider extends
...
//        private BeanDefinitionRegistry registry;
    ...
    protected boolean isCandidateComponent(AnnotatedBeanDefinition beanDefinition) {
      boolean isNonRepositoryInterface = !isGenericRepositoryInterface(
  ...
  private static class InterfaceTypeFilter extends AssignableTypeFilter {
    ...
    public boolean match(MetadataReader metadataReader, MetadataReaderFactory metadataReaderFactory)
        throws IOException {
      return metadataReader.getClassMetadata().isInterface() && super
