...
public class IndexTools {
  ...
  public MetaData getMetaData(Class<?> clazz) {
    ...
    if (clazz.getAnnotation(ESMetaData.class) != null) {
      ...
      metaData.setRolloverMaxIndexAgeCondition(
          clazz.getAnnotation(ESMetaData.class).rolloverMaxIndexAgeCondition());
      metaData.setRolloverMaxIndexAgeTimeUnit(
          clazz.getAnnotation(ESMetaData.class).rolloverMaxIndexAgeTimeUnit());
      metaData.setRolloverMaxIndexDocsCondition(
          clazz.getAnnotation(ESMetaData.class).rolloverMaxIndexDocsCondition());
      metaData.setRolloverMaxIndexSizeCondition(
          clazz.getAnnotation(ESMetaData.class).rolloverMaxIndexSizeCondition());
      metaData.setRolloverMaxIndexSizeByteSizeUnit(
          clazz.getAnnotation(ESMetaData.class).rolloverMaxIndexSizeByteSizeUnit());
