...
/**
 * Description：RocketMQ消费抽象基类 Created by Jay Chang on 2017/9/14 Modified By：
 */
public abstract class AbstractMQConsumer<T> {
  ...
  protected Map<String, Object> parseExtParam(MessageExt message) {
    ...
    extMap.put(MessageExtConst.PROPERTY_EXT_PREPARED_TRANSACTION_OFFSET,
        message.getPreparedTransactionOffset());
