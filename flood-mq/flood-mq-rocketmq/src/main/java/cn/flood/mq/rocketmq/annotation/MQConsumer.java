...
/**
 * Created by yipin on 2017/6/27. RocketMQ消费者自动装配注解
 */
...
public @interface MQConsumer {
  ...
  /**
   * 使用线程池并发消费: CONCURRENTLY("CONCURRENTLY"), 单线程消费: ORDERLY("ORDERLY");
   *
   * @return 消费模式
   */
  ...
  /**
   * 是否去重，默认DEDUP_DISABLE 不开启 不开启去重， DEDUP_DISABLE 开启去重 DEDUP_CONSUME_LATER
   *
   * @return
   */
