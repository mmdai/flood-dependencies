...
public class ConsumerProperties {
  ...
  /**
   * setup retry topic. The default dead letter topic uses this format
   * <tenancy>/<namespace>/<topicName>-RETRY
   */
  private String retryTopic;
  /**
   * setup dead letter topic The default dead letter topic uses this format
  ...
  /**
   * Set the timeout for unacked messages, truncated to the nearest millisecond. The timeout needs
   * to be greater than 1 second. default 30s
   */
  ...
  /**
   * Sets the size of the consumer receive queue. default 1000
   */
  ...
  /**
   * If enabled, the consumer will auto retry message. default unable.
   */
  ...
  /**
   * A plugin interface that allows you to intercept (and possibly mutate) messages received by the
   * consumer.
   */
