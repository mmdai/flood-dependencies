package cn.flood.mq.pulsar.listener;

import cn.flood.mq.pulsar.event.MessageEvent;
...
/**
 * Customize the message processing listener. Need to manual ack. Listens for new messages and
