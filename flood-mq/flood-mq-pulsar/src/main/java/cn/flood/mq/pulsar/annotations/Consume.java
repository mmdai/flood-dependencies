...
public @interface Consume {
   ...
   * Consumer} before the
   * application calls {@link Consumer#receive()}. Using a higher value could potentially increase
   * the consumer throughput at the expense of bigger memory utilization.
   *
