package cn.flood.pulsar.client;

import cn.flood.pulsar.annotations.Consume;
import cn.flood.pulsar.annotations.PulsarListener;
import cn.flood.pulsar.annotations.TopicBinding;
import cn.flood.pulsar.beans.TopicNameComponent;
import cn.flood.pulsar.config.ConsumerProperties;
import cn.flood.pulsar.config.PulsarProperties;
import cn.flood.pulsar.constants.PulsarConstants;
import cn.flood.pulsar.listener.ConsumerMessageListener;
import cn.flood.pulsar.utils.PulsarUtils;
...
public class PulsarConsumeClient implements BeanPostProcessor {
    ...
    private Consumer<String> createConsumer(TopicNameComponent topicNameComponent, ConsumerProperties consumerConfig,
    ...
    private DeadLetterPolicy createDeadLetterPolicy(TopicNameComponent topicNameComponent, ConsumerProperties consumerConfig, List<String> topics) {
