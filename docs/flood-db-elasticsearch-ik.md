...
2.在org.wltea.analyzer.dic下添加DictLoader

3.在org.wltea.analyzer.dic下修改
1) 原来是private的，现在想在DictLoader调用这个方法，改成了public的

private String getDictRoot() 修改public String getDictRoot()

2) 在public static synchronized void initial(Configuration cfg)里面添加
