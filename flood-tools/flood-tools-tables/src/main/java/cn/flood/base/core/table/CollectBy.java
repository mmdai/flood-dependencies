...
public class CollectBy implements Cloneable {
  ...
  public static void main(String[] args) {
    ...
    List left = JSON.parseArray(new StringBuffer().append(
        "[{\"org_level\":\"RVP\",\"dept_id\":\"R100015558\",\"psid\":\"100015558\",\"name\":\"赵文欣\",\"store_count\":1919,\"bgm_name\":\"全国\",\"rvp_name\":\"赵文欣\"},{\"org_level\":\"RVP\",\"dept_id\":\"00100081\",\"psid\":\"100052049\",\"name\":\"陈光全\",\"store_count\":325,\"bgm_name\":\"全国\",\"rvp_name\":\"陈光全\"},{\"org_level\":\"RVP\",\"dept_id\":\"R100055169\",\"psid\":\"100055169\",\"name\":\"汪涛\",\"store_count\":1463,\"bgm_name\":\"全国\",\"rvp_name\":\"汪涛\"},{\"org_level\":\"RVP\",\"dept_id\":\"R100055433\",\"psid\":\"100055433\",\"name\":\"王越\",\"store_count\":964,\"bgm_name\":\"全国\",\"rvp_name\":\"王越\"},{\"org_level\":\"RVP\",\"dept_id\":\"R100102942\",\"psid\":\"100102942\",\"name\":\"包莹瑞\",\"store_count\":1475,\"bgm_name\":\"全国\",\"rvp_name\":\"包莹瑞\"}]")
        .toString(), Map.class);
    List right = JSON.parseArray(new StringBuffer().append(
        "[{\"org_level\":\"RVP\",\"dept_id\":\"R100055169\",\"primeSource\":\"大神卡\",\"primeType\":\"一店一码-其  他\",\"primeNumber\":\"552\"},{\"dept_id\":\"00100081\",\"primesource\":\"宅神卡\",\"primetype\":\"宅急送\",\"primenumber\":\"4,106\"}]")
        .toString(), Map.class);
    CollectBy by = new CollectBy();
    System.out.println(left.size());
    System.out.println(right.size());
    List result = by.table(left, right, "{'dept_id':'dept_id','org_level':'org_level'}").leftJoin()
        .list();
...
//        System.out.println(JSON.toJSON(result7));
   ...
   * @return
   */
  public List<Map> group(List<Map> left, String select, String groupBy, Map<String, Object> where,
      Map ext, EachRow row) {
  ...
  public List<Map> innerJoin(List<Map> left, List<Map> right, String select, Map on, Map where,
      Map ext, EachRow row) {
    List<Map> result = new ArrayList();
    if (on == null || on.isEmpty() || left == null || left.isEmpty() || right == null || right
        .isEmpty()) {
   ...
   * @return
   */
  public List<Map> fullJoin(List<Map> left, List<Map> right, String select, Map on, Map where,
      Map ext, EachRow row) {
    List<Map> result = new ArrayList();
    if (on == null || on.isEmpty() || left == null || left.isEmpty() || right == null || right
        .isEmpty()) {
