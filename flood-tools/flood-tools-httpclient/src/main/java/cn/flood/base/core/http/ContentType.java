...
public class ContentType {
  ...
  public static final ContentType APPLICATION_XLS = create("application/vnd.ms-excel",
      (Charset) null);
  public static final ContentType APPLICATION_PPT = create("application/vnd.ms-powerpoint",
      (Charset) null);
  //apk or ios
  public static final ContentType APPLICATION_APK = create(
      "application/vnd.android.package-archive", (Charset) null);
