...
public final class DateUtils {
  ...
  public static String getLastNWeekBeginDate(int n, DateTimeFormatter formatter) {
    return LocalDate.now().plusWeeks(n).with(WeekFields.of(Locale.FRANCE).dayOfWeek(), 1)
        .format(formatter);
  }
  ...
  public static String getLastNWeekEndDate(int n, DateTimeFormatter formatter) {
    return LocalDate.now().plusWeeks(n).with(WeekFields.of(Locale.FRANCE).dayOfWeek(), 7)
        .format(formatter);
  }
  ...
  public static String getLastNMonthBeginDate(int n, DateTimeFormatter formatter) {
    return LocalDate.now().plusMonths(n).with(TemporalAdjusters.firstDayOfMonth())
        .format(formatter);
  }
