...
import cn.flood.base.core.support.StrFormatter;
import cn.flood.base.core.support.StrSpliter;
...
//    }
  ...
  public static String[] splitAtFirst(String toSplit, String delimiter) {
    ...
    return new String[]{toSplit.substring(0, offset),
        toSplit.substring(offset + delimiter.length())};
  }
   ...
   * @return
   */
  public static String getLength(String s, int num) {
    int valueLength = 0;
    String chinese = "[\u4e00-\u9fa5]";
   ...
   * @since 3.0.8
   */
  public static List<String> split(CharSequence str, char separator, boolean isTrim,
      boolean ignoreEmpty) {
