...
import cn.flood.base.core.lang.IoUtil;
import cn.flood.base.core.lang.NumberUtils;
import cn.flood.base.core.lang.StringUtils;
import cn.flood.base.core.utils.BeanUtil;
...
public class Func {
  ...
  public static void nullOrEmptyThrow(Object obj, String code, String message) {
    StringUtils.nullOrEmptyThrow(obj, code, message);
  }
  ...
  public static String firstCharToUpper(String str) {
    return StringUtils.upperFirst(str);
  }
  ...
  public static boolean equalsSafe(@Nullable Object o1, @Nullable Object o2) {
    return StringUtils.nullSafeEquals(o1, o2);
  }
  ...
  public static String encodeBase64(String value) {
    return cn.flood.base.core.binary.Base64.encode(value);
  }
  ...
  public static String encodeBase64(String value, Charset charset) {
    return cn.flood.base.core.binary.Base64.encode(value, charset);
  }
  ...
  public static String encodeBase64UrlSafe(String value) {
    return cn.flood.base.core.binary.Base64.encode(value, true);
  }
  ...
  public static String encodeBase64UrlSafe(String value, Charset charset) {
    return cn.flood.base.core.binary.Base64.encode(value, charset, true);
  }
  ...
  public static String decodeBase64(String value) {
    return cn.flood.base.core.binary.Base64.decode2String(value);
  }
  ...
  public static String decodeBase64UrlSafe(String value) {
    return cn.flood.base.core.binary.Base64.decode2String(value, true);
  }
   ...
   * @return jsonString json字符串
   */
  public static String toJSONString(Object object, Supplier<String> defaultSupplier) {
    return JsonUtils.toJSONString(object, defaultSupplier);
  }
  ...
  public static <T> T parse(String jsonString, Class<T> valueType) {
    return JsonUtils.toJavaObject(jsonString, valueType);
  }
   ...
   * @return Bean
   */
  public static <T> T parse(String jsonString, Class<T> valueType, Supplier<T> defaultSupplier) {
    return JsonUtils.toJavaObject(jsonString, valueType, defaultSupplier);
  }
  ...
  public static <T> List<T> parseList(String value, Class<T> tClass) {
    return JsonUtils.toJavaObjectList(value, tClass);
  }
  ...
  public static <T> List<T> parseList(Object obj, Class<T> tClass) {
    return JsonUtils.toJavaObjectList(obj, tClass);
  }
