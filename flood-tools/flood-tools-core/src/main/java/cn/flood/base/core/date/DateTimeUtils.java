...
public class DateTimeUtils {
    ...
    public static String getLastNWeekBeginDate(int n, DateTimeFormatter formatter) {
        return LocalDateTime.now().plusWeeks(n).with(WeekFields.of(Locale.FRANCE).dayOfWeek(), 1).format(formatter);
    }
    ...
    public static String getLastNWeekEndDate(int n, DateTimeFormatter formatter) {
        return LocalDateTime.now().plusWeeks(n).with(WeekFields.of(Locale.FRANCE).dayOfWeek(), 7).format(formatter);
    }
    ...
    public static String getLastNMonthBeginDate(int n, DateTimeFormatter formatter) {
        return LocalDateTime.now().plusMonths(n).with(TemporalAdjusters.firstDayOfMonth()).format(formatter);
    }
    ...
    public static String getLastNMonthEndDate(int n, DateTimeFormatter formatter) {
        return LocalDateTime.now().plusMonths(n).with(TemporalAdjusters.lastDayOfMonth()).format(formatter);
    }
    ...
    public static String getLastNYearBeginDate(int n, DateTimeFormatter formatter) {
        return LocalDateTime.now().plusYears(n).with(TemporalAdjusters.firstDayOfYear()).format(formatter);
    }
    ...
    public static String getLastNYearEndDate(int n, DateTimeFormatter formatter) {
        return LocalDateTime.now().plusYears(n).with(TemporalAdjusters.lastDayOfYear()).format(formatter);
    }
