...
//		String s = new String("{\"partnerToken\":\"21321fdsafdsafdsa\"}");
//		System.out.println("原始：" + s);
//		String sign = sign(s, "123456", "utf-8");
//		System.out.println("MD5后：" + sign);
//		System.out.println("MD5后：" + verify(s, sign, "123456", "utf-8"));
//		System.out.println("MD5后再加密：" + KL(sign(s, "utf-8")));
//		System.out.println("解密为MD5后的：" + JM(KL(sign(s, "utf-8"))));
