...
/**
 * 对称加密 这里面的API里面有很多是调用getInstance方法，这个方法的参数有algorithm或者transformation 一：algorithm：算法
 * <p>
 * 二：transformation：有两种格式 1：算法/模式/填充方式。如：DES/CBC/PKCS5Padding 2：算法。
 * 如：DES
 * <p>
 * 其中，algorithm、transformation的值，不区分大小写
 * <p>
 * Java加密解密官方参考文档： https://docs.oracle.com/javase/8/docs/technotes/guides/security/index.html
