...
public class RegularExpUtils {
  ...
  /**
   * 校验注册规则， 默认包含以下4种字符类型的任意3种组合， 默认密码长度为8位 默认密码中不能包含账号
   *
   * @param password
   * @param username
   * @return
  ...
  /**
   * 校验注册规则， 1. 包含以下4种字符类型的任意{pwdTypeSize}种组合 2. 密码长度{pwdLength}，最小6位，最大30位 3.
   * 密码中不能包含账号校验{pwdNoAccountCheck}
   *
   * @param password
   * @param username
   ...
   * @return
   */
  public static boolean checkPasswordRule(String password, String username, int pwdTypeSize,
      int pwdLength,
