...
import cn.flood.tools.uid.baidu.utils.DateUtils;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
  ...
  /**
   * Customer epoch, unit as second. For example 2022-01-01 (ms: 1640966400000)
   */
  protected String epochStr = "2022-01-01";
  protected long epochSeconds = TimeUnit.MILLISECONDS.toSeconds(1640966400000L);
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    LOGGER.info("Initialized bits(1, {}, {}, {}) for workerID:{}", timeBits, workerBits, seqBits,
        workerId);
  }
  ...
  public String parseUID(long uid) {
    ...
    // format as string
    return String
        .format("{\"UID\":\"%d\",\"timestamp\":\"%s\",\"workerId\":\"%d\",\"sequence\":\"%d\"}",
  ...
  public void setEpochStr(String epochStr) {
    if (!ObjectUtils.isEmpty(epochStr)) {
      ...
      this.epochSeconds = TimeUnit.MILLISECONDS
          .toSeconds(DateUtils.parseByDayPattern(epochStr).getTime());
    }
  }
}