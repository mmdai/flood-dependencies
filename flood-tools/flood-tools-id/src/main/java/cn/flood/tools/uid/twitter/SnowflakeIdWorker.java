...
public class SnowflakeIdWorker {
  ...
  // ==============================Fields===========================================
  /**
   * 开始时间截 (2022-01-01)，用于用当前时间戳减去这个时间戳，算出偏移量
   */
  ...
  public SnowflakeIdWorker(long workerId, long datacenterId) {
    ...
    if (datacenterId > maxDatacenterId || datacenterId < 0) {
      throw new IllegalArgumentException(
          String.format(ERROR_ATTR_LIMIT, "datacenterId", maxDatacenterId));
    }
  ...
  public String parseUID(Long uid) {
    ...
    long workerId =
        (uid << (timestampBits + signBits + datacenterIdBits)) >>> (totalBits - workerIdBits);
  ...
  public String parseUID(String uid) {
    ...
    // 格式化输出
    return String.format(MSG_UID_PARSE, uid, date, Integer.valueOf(workerId, 2),
        Integer.valueOf(dataCenterId, 2), Integer.valueOf(sequence, 2));
  }
