 ...
 */
package cn.flood.tools.uid.baidu.impl;

import cn.flood.tools.uid.baidu.BitsAllocator;
import cn.flood.tools.uid.baidu.UidGenerator;
import cn.flood.tools.uid.baidu.buffer.BufferPaddingExecutor;
import cn.flood.tools.uid.baidu.buffer.BufferedUidProvider;
import cn.flood.tools.uid.baidu.buffer.RejectedPutBufferHandler;
import cn.flood.tools.uid.baidu.buffer.RejectedTakeBufferHandler;
import cn.flood.tools.uid.baidu.buffer.RingBuffer;
import cn.flood.tools.uid.baidu.exception.UidGenerateException;
 ...
 * DefaultUidGenerator}, based on a lock free {@link RingBuffer}<p>
 * <p>
 ...
 * the buffer size will be <code>({@link BitsAllocator#getMaxSequence()} + 1) &lt;&lt; {@link
 * #boostPower}</code>, Default as {@value #DEFAULT_BOOST_POWER}
 ...
 * RingBuffer#DEFAULT_PADDING_PERCENT} Sample: paddingFactor=20, bufferSize=1000 -> threshold=1000 *
 * 20 /100, padding buffer will be triggered when tail-cursor<threshold
