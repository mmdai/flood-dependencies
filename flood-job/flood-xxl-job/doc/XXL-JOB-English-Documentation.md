...
The concret content of configuration file as follows:
    ...
    ### xxl-job, access userToken：xxl-job access userToken,enabled if it not blank
    xxl.job.accessToken=
...
<bean id="xxlJobExecutor" class="com.xxl.job.core.executor.XxlJobExecutor" init-method="start" destroy-method="destroy" >
    ...
    <!-- access userToken, match check enabled if it not blank[required] -->
...
The scheduling center API service requests reference code：AdminBizTest.java
